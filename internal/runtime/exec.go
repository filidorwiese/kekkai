...
// in the mirrored project path (specs/026), and passes its exit code
// through. A TTY is allocated only when stdin is a terminal so piped
// invocations keep working (research.md R1).
